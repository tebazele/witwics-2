...
function returnIndex(arr, str) {
  // TODO your code here
  let index = arr.findIndex((elem) => elem == str);
  return index;
}
...
function bandMemberDetails(name) {
  // TODO YOUR CODE HERE
  let foundPerson = theBand.members.find((member) =>
    member.name.toLowerCase().includes(name.toLowerCase())
  );
  return `${foundPerson.name} is in the band and plays the ${foundPerson.instrument}`;
}
